...
set_property PACKAGE_PIN R10 [get_ports {custominA[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {custominA[0]}]
set_property PULLDOWN true [get_ports {custominA[0]}]
set_property PACKAGE_PIN R12 [get_ports {custominB[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {custominB[0]}]
set_property PULLDOWN true [get_ports {custominB[0]}]
set_property PACKAGE_PIN R13 [get_ports {custominC[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {custominC[0]}]
set_property PULLDOWN true [get_ports {custominC[0]}]
